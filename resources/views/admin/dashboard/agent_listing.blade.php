            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Agent Listing</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Agent Listing</h3>
                    </div>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover dataTable dtr-inline"
                                        ...
                                        <?php $no = 1; foreach($res as $key=>$val) { ?>
                                            <tr role="row">
                                                ...
                                                <td class="value">
                                                    <a href="{{ url('agent_full_info/' . $val->id )}}"> 
                                            ...
                                            <td class=" last">                                             
                                                <a class="fa fa-pencil" href="{{ url('add_agent/' . $val->id )}}"> Edit</a> &nbsp;                                               
                                                 <a class="fa fa-eye" href="{{ url('agent_full_info/' . $val->id )}}"> View</a>
                                            </td>
                                            </tr>
                                          <?php $no++; } ?>
                                        </tbody>
...
<script>
    ...
    function submitForm(id,status){
        window.location.href =  'listactiveAgent/'+id+'/'+status;
    }
</script>